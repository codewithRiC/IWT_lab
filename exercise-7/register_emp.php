...
if(isset($_POST['name'])){
    ...
    $sql = "INSERT INTO `iwt_admin_emp`.`employee` (`empid`,`name`, `age`,`phone`,`password`) VALUES ('$empid','$name', '$age','$phone','$password');";
...
<body>
    ...
    <div class="whole">
        ...
        echo "<a class='btn' href='login_emp.php'><button>LOGIN</button></a>";
        }
